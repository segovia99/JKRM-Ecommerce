          ...
          <div className='flex-1'>
            <div className='welcome-msg w-full'>
              <div>
                ...
                <h1 className='font-bold text-[24px] text-black'>{user.nombre} {user.apellido}</h1>
              </div>
            </div>
                ...
                <div className='mt-5'>
                  <table>
                    <tr className='inline-flex mb-5'>
                      ...
                      <td className='text-base text-qblack font-medium'>{user.nombre} {user.apellido}</td>
                    ...
                    <tr className='inline-flex mb-5'>
                      ...
                      <td className='text-base text-qblack font-medium'>{user.direccion}</td>
                    </tr>
