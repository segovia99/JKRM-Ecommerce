            ...
            <Form onSubmit={handleSubmit}>
              <div className='space-y-4 md:space-y-6'>
                <div className='grid gap-6 mb-6 md:grid-cols-2'>
                  ...
                  <div>
                    <label htmlFor='last_name' name='apellido' className='block mb-2 text-sm font-medium text-gray-900'>Apellido</label>
                    <input
                ...
                <div>
                  <label htmlFor='direccion' className='block mb-2 text-sm font-medium text-gray-900 dark1:text-white'>Dirección</label>
                ...
                <div>
                  <label htmlFor='email' className='block mb-2 text-sm font-medium text-gray-900 dark1:text-white'>correo electrónico</label>
                  <input type='email' name='email' className='bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark1:bg-gray-700 dark1:border-gray-600 dark1:placeholder-gray-400 dark1:text-white dark1:focus:ring-blue-500 dark1:focus:border-blue-500' placeholder='name@company.com' onChange={handleChange} value={values.email} required='' />
                </div>
                <div>
                  <label htmlFor='password' className='block mb-2 text-sm font-medium text-gray-900 dark1:text-white'>contraseña</label>
                ...
                <div className='flex items-start'>
                  ...
                  <div className='ml-3 text-sm'>
                    <label htmlFor='terms' className='font-light text-gray-500 dark1:text-gray-300'>acepto los <a className='font-medium text-primary-600 hover:underline dark1:text-primary-500' href='#'>Terminos y Condiciones</a></label>
                  </div>
                </div>
