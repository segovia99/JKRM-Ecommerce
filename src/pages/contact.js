          ...
          <div className='page-title-wrapper bg-[#FFFAEF] w-full h-[173px] py-10'>
            <div className='container-x mx-auto'>
              <div className='flex justify-center'>
                <h1 className='text-3xl font-semibold text-qblack'>Contacto</h1>
              </div>
            </div>
          </div>
        </div>
        <div className='contact-wrapper w-full pb-10'>
          <div className='container-x mx-auto'>
            <div className='main-wrapper w-full lg:flex lg:space-x-[30px]'>
              <div className='lg:w-1/2 w-full'>
                <h1 className='text-[22px] font-semibold text-qblack leading-[30px] mb-1'>Informacion de Contacto</h1>
                <p className='text-[15px] text-qgraytwo leading-[30px] mb-5'>Llena el siguiente formulario o escríbenos. Te ayudaremos lo antes posible.</p>
                ...
                <div className='p-5 flex flex-col justify-between w-full bg-[#E7F2EC]'>
                  ...
                  <div className='w-full h-[206px] mt-5'>
                    <iframe
                      ...
                      src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387548.3901657616!2d-89.24647725854778!3d13.692940224508653!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f66977e1f4d3b1f%3A0x742ab7e52c3c4a0a!2sSan%20Salvador%2C%20El%20Salvador!5e0!3m2!1sen!2sus!4v1656755618576!5m2!1sen!2sus'
                    />
                  </div>
                </div>
              </div>
              <div className='flex-1 bg-white sm:p-10 p-3'>
                <div className='title flex flex-col items-center'>
                  <h1 className='text-[34px] font-bold text-qblack'>Contactanos</h1>
                  <span className='-mt-5 block'>
                    <svg width='354' height='30' viewBox='0 0 354 30' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M1 28.8027C17.6508 20.3626 63.9476 8.17089 113.509 17.8802C166.729 28.3062 341.329 42.704 353 1' stroke='#db1436' strokeWidth='2' strokeLinecap='round' /></svg>
                  </span>
                </div>
                          ...
                          <Form onSubmit={handleSubmit}>
                            <div className='mb-4'>
                              <div className='input-com w-full h-full'>
                                <label className='input-label capitalize block  mb-2 text-qgray text-[13px] font-normal'>Nombre*</label>
                                <div className='input-wrapper border border-qgray-border w-full h-full overflow-hidden relative '>
                                  <input type='text' name='name' id='name' className='input-field placeholder:text-sm text-sm px-6 text-dark-gray w-full  font-normal bg-white focus:ring-0 focus:outline-none h-[50px]' placeholder='Nombre' required onChange={handleChange} value={values.name} />
                                </div>
                              </div>
                            </div>
                            ...
                            <div className='mb-4'>
                              <div className='input-com w-full h-full'>
                                ...
                                <div className='input-wrapper border border-qgray-border w-full h-full overflow-hidden relative '>
                                  <input type='email' name='email' id='email' className='input-field placeholder:text-sm text-sm px-6 text-dark-gray w-full  font-normal bg-white focus:ring-0 focus:outline-none h-[50px]' placeholder='soporte@jkrm.com' required onChange={handleChange} value={values.email} />
                                </div>
                              </div>
                            </div>
                            ...
                            <div className='mb-4'>
                              <div className='input-com w-full h-full'>
                                <label className='input-label capitalize block  mb-2 text-qgray text-[13px] font-normal'>Asunto</label>
                                <div className='input-wrapper border border-qgray-border w-full h-full overflow-hidden relative '>
                                  <input type='text' name='subject' id='subject' className='input-field placeholder:text-sm text-sm px-6 text-dark-gray w-full  font-normal bg-white focus:ring-0 focus:outline-none h-[50px]' placeholder='Asunto' required onChange={handleChange} value={values.subject} />
                                </div>
                              </div>
                            </div>
                            ...
                            <div className='mb-5'>
                              <div className='input-com w-full h-full'>
                                <label className='input-label capitalize block  mb-2 text-qgray text-[13px] font-normal'>Mensaje*</label>
                                <textarea
                                  className='w-full h-[105px] focus:ring-0 focus:outline-none p-3 border border-qgray-border placeholder:text-sm' name='message' required placeholder='escribe tu mensaje aqui'
                                  onChange={handleChange} value={values.message}
                                />
                              </div>
                            </div>

                            <button className='black-btn text-sm font-semibold w-full h-[50px] flex justify-center items-center'>
                              Enviar
                            </button>
